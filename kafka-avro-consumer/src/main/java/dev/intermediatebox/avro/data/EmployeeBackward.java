...
public class EmployeeBackward extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1160769563185103098L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EmployeeBackward\",\"namespace\":\"dev.intermediatebox.avro.data\",\"fields\":[{\"name\":\"firstName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"lastName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"maritalStatus\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"UNKNOWN\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static final SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<EmployeeBackward> ENCODER =
      new BinaryMessageEncoder<EmployeeBackward>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<EmployeeBackward> DECODER =
      new BinaryMessageDecoder<EmployeeBackward>(MODEL$, SCHEMA$);
  ...
  public static BinaryMessageDecoder<EmployeeBackward> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<EmployeeBackward>(MODEL$, SCHEMA$, resolver);
  }
   ...
   */
  public static dev.intermediatebox.avro.data.EmployeeBackward.Builder newBuilder() {
    return new dev.intermediatebox.avro.data.EmployeeBackward.Builder();
  }
   ...
   * @return A new EmployeeBackward RecordBuilder
   */
  public static dev.intermediatebox.avro.data.EmployeeBackward.Builder newBuilder(dev.intermediatebox.avro.data.EmployeeBackward.Builder other) {
    if (other == null) {
      return new dev.intermediatebox.avro.data.EmployeeBackward.Builder();
    } else {
      return new dev.intermediatebox.avro.data.EmployeeBackward.Builder(other);
    }
  }
   ...
   * @return A new EmployeeBackward RecordBuilder
   */
  public static dev.intermediatebox.avro.data.EmployeeBackward.Builder newBuilder(dev.intermediatebox.avro.data.EmployeeBackward other) {
    if (other == null) {
      return new dev.intermediatebox.avro.data.EmployeeBackward.Builder();
    } else {
      return new dev.intermediatebox.avro.data.EmployeeBackward.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EmployeeBackward>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(dev.intermediatebox.avro.data.EmployeeBackward.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(dev.intermediatebox.avro.data.EmployeeBackward other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.firstName)) {
        this.firstName = data().deepCopy(fields()[0].schema(), other.firstName);
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.intermediatebox.avro.data.EmployeeBackward.Builder setFirstName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.intermediatebox.avro.data.EmployeeBackward.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.intermediatebox.avro.data.EmployeeBackward.Builder setLastName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.intermediatebox.avro.data.EmployeeBackward.Builder clearLastName() {
      lastName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.intermediatebox.avro.data.EmployeeBackward.Builder setMaritalStatus(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.intermediatebox.avro.data.EmployeeBackward.Builder clearMaritalStatus() {
      maritalStatus = null;
