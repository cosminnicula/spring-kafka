...
public class Hello extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Hello\",\"namespace\":\"dev.intermediatebox.avro.data\",\"doc\":\"Hello world avro\",\"fields\":[{\"name\":\"myStringField\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"Just a string\"},{\"name\":\"myIntField\",\"type\":\"int\",\"doc\":\"Just an int\"}]}");
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Hello>
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.intermediatebox.avro.data.Hello.Builder setMyStringField(java.lang.String value) {
