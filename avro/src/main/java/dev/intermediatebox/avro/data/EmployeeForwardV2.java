...
public class EmployeeForwardV2 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5198093409584116661L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EmployeeForwardV2\",\"namespace\":\"dev.intermediatebox.avro.data\",\"fields\":[{\"name\":\"firstName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"lastName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"email\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static final SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<EmployeeForwardV2> ENCODER =
      new BinaryMessageEncoder<EmployeeForwardV2>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<EmployeeForwardV2> DECODER =
      new BinaryMessageDecoder<EmployeeForwardV2>(MODEL$, SCHEMA$);
  ...
  public static BinaryMessageDecoder<EmployeeForwardV2> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<EmployeeForwardV2>(MODEL$, SCHEMA$, resolver);
  }
   ...
   */
  public static dev.intermediatebox.avro.data.EmployeeForwardV2.Builder newBuilder() {
    return new dev.intermediatebox.avro.data.EmployeeForwardV2.Builder();
  }
   ...
   * @return A new EmployeeForwardV2 RecordBuilder
   */
  public static dev.intermediatebox.avro.data.EmployeeForwardV2.Builder newBuilder(dev.intermediatebox.avro.data.EmployeeForwardV2.Builder other) {
    if (other == null) {
      return new dev.intermediatebox.avro.data.EmployeeForwardV2.Builder();
    } else {
      return new dev.intermediatebox.avro.data.EmployeeForwardV2.Builder(other);
    }
  }
   ...
   * @return A new EmployeeForwardV2 RecordBuilder
   */
  public static dev.intermediatebox.avro.data.EmployeeForwardV2.Builder newBuilder(dev.intermediatebox.avro.data.EmployeeForwardV2 other) {
    if (other == null) {
      return new dev.intermediatebox.avro.data.EmployeeForwardV2.Builder();
    } else {
      return new dev.intermediatebox.avro.data.EmployeeForwardV2.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EmployeeForwardV2>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(dev.intermediatebox.avro.data.EmployeeForwardV2.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(dev.intermediatebox.avro.data.EmployeeForwardV2 other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.firstName)) {
        this.firstName = data().deepCopy(fields()[0].schema(), other.firstName);
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.intermediatebox.avro.data.EmployeeForwardV2.Builder setFirstName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.intermediatebox.avro.data.EmployeeForwardV2.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.intermediatebox.avro.data.EmployeeForwardV2.Builder setLastName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.intermediatebox.avro.data.EmployeeForwardV2.Builder clearLastName() {
      lastName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.intermediatebox.avro.data.EmployeeForwardV2.Builder setEmail(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.intermediatebox.avro.data.EmployeeForwardV2.Builder clearEmail() {
      email = null;
