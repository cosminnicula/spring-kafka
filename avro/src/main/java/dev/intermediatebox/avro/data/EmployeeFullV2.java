...
public class EmployeeFullV2 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6712708276901773416L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EmployeeFullV2\",\"namespace\":\"dev.intermediatebox.avro.data\",\"fields\":[{\"name\":\"firstName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"location\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"default\":\"head-office\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static final SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<EmployeeFullV2> ENCODER =
      new BinaryMessageEncoder<EmployeeFullV2>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<EmployeeFullV2> DECODER =
      new BinaryMessageDecoder<EmployeeFullV2>(MODEL$, SCHEMA$);
  ...
  public static BinaryMessageDecoder<EmployeeFullV2> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<EmployeeFullV2>(MODEL$, SCHEMA$, resolver);
  }
   ...
   */
  public static dev.intermediatebox.avro.data.EmployeeFullV2.Builder newBuilder() {
    return new dev.intermediatebox.avro.data.EmployeeFullV2.Builder();
  }
   ...
   * @return A new EmployeeFullV2 RecordBuilder
   */
  public static dev.intermediatebox.avro.data.EmployeeFullV2.Builder newBuilder(dev.intermediatebox.avro.data.EmployeeFullV2.Builder other) {
    if (other == null) {
      return new dev.intermediatebox.avro.data.EmployeeFullV2.Builder();
    } else {
      return new dev.intermediatebox.avro.data.EmployeeFullV2.Builder(other);
    }
  }
   ...
   * @return A new EmployeeFullV2 RecordBuilder
   */
  public static dev.intermediatebox.avro.data.EmployeeFullV2.Builder newBuilder(dev.intermediatebox.avro.data.EmployeeFullV2 other) {
    if (other == null) {
      return new dev.intermediatebox.avro.data.EmployeeFullV2.Builder();
    } else {
      return new dev.intermediatebox.avro.data.EmployeeFullV2.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EmployeeFullV2>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(dev.intermediatebox.avro.data.EmployeeFullV2.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(dev.intermediatebox.avro.data.EmployeeFullV2 other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.firstName)) {
        this.firstName = data().deepCopy(fields()[0].schema(), other.firstName);
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.intermediatebox.avro.data.EmployeeFullV2.Builder setFirstName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.intermediatebox.avro.data.EmployeeFullV2.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.intermediatebox.avro.data.EmployeeFullV2.Builder setLocation(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.intermediatebox.avro.data.EmployeeFullV2.Builder clearLocation() {
      location = null;
